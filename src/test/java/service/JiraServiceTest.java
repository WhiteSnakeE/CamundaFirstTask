...
public class JiraServiceTest {
    private static final String ID = "https://sytoss.atlassian.net/rest/api/3/issue/14403";
    ...
    void happy() throws Exception {
        ...
        JiraIssue jiraIssue =
                new JiraIssue("https://sytoss.atlassian.net/rest/api/3/issue/14411",
        ...
        assertEquals(jiraIssueList.get(1).getSelf(), ID);
